 ...
 * Professional order message builder for itsec.az
 * Generates formatted AZ/EN/RU messages with product details,
 * quantity, pricing, warranty, and optional contract notes.
 */
import React, { useState } from 'react';
import { MessageCircle, Copy, CheckCheck, FileText, Package, Tag, Star, ChevronDown, ChevronUp } from 'lucide-react';
...
function buildMessage(
  ...
  const header: Record<string, string> = {
    az: `🛒 *YENİ SİFARİŞ — itsec.az*\n📅 Tarix: ${dateStr} ${timeStr}`,
    en: `🛒 *NEW ORDER — itsec.az*\n📅 Date: ${dateStr} ${timeStr}`,
    ru: `🛒 *НОВЫЙ ЗАКАЗ — itsec.az*\n📅 Дата: ${dateStr} ${timeStr}`,
  };
