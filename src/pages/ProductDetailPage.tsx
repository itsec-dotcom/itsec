...
import { ShoppingCart, Heart, ChevronRight, Shield, Truck, Phone, CheckCircle, MessageCircle, Scale } from 'lucide-react';
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <Button variant="ghost" size="icon" title="Compare" className={`border ${isInCompare(product.id) ? 'border-primary text-primary bg-primary/10' : 'border-border text-muted-foreground hover:text-primary'}`} onClick={() => isInCompare(product.id) ? removeFromCompare(product.id) : addToCompare(product)}>
              <Scale size={18} />
            </Button>
          </div>
